        ...
        do {
            ...
            if (userRounds <= 10 && userRounds > 0) {
                ...
                if (winCounter > loseCounter) {
                    ...
                    System.out.println("You: " + winCounter + " wins vs. " + loseCounter + " computer wins and " + tieCounter + " ties!!");
                } else {
                    System.out.println("#sadlife. You lost to an inanimate object.");
                    System.out.println("Scoreboard:  You " + winCounter + " wins vs. " + loseCounter + " computer wins and " + tieCounter + " ties lmao");
                }
