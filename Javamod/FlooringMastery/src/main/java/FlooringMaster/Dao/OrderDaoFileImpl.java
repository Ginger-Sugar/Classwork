 ...
 */
public class OrderDaoFileImpl implements OrdersDao {
    ...
    public OrderDaoFileImpl(String dataFolder) {
    ...
    private void readLastOrderNumber() throws FMPersistenceException {
        ...
        try {
            //Create Scanner to read user input to find the file
            scanner = new Scanner(
                    new BufferedReader(
            ...
            throw new FMPersistenceException(
                    ":'( Your file could not be loaded........ #sad.", e);
        }
        ...
        if (f.isFile()) {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (currentTokens.length == 12) {
                    ...
                    currentOrder.setArea(new BigDecimal(currentTokens[3]));
